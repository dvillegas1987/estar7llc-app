...
class OrderReturnRequestsController extends AdminBaseController
{
    ...
    public function view($orrequest_id)
    {
        ...
        $srch->addMultipleFields(
            ...
            'op_commission_include_shipping', 'op_commission_include_tax', 'op_free_ship_upto', 'op_actual_shipping_charges', 
            'order_pmethod_id','op_rounding_off','op_selprod_user_id','opshipping_by_seller_user_id')
        );
